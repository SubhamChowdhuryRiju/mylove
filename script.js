...
noBtn.addEventListener('click', () => {
    ...
    if (noClickCount === 1) {
        ...
        subtext.innerHTML = "itni jaldi na matt bolo 😪";
        ...
        subtext.innerHTML = "kyu aisa kar rahi ho Pls Maan jao🥺";
        ...
        mainHeading.innerHTML = "beautiful pls Man jao na! Kitna code likh waogi 😭";
...
yesBtn.addEventListener('click', () => {
    ...
    mainHeading.innerHTML = "I knew it! You Love me a lot 😘";
